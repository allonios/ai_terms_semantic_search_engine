...
def fast_calc_similarity(name1_tokens, name2_tokens):
    ...
    for i1, w1 in enumerate(name1_tokens):
        for _, _w2 in enumerate(name2_tokens):
...
def sim_vec(
    ...
    elif isinstance(e1, ObjectPropertyClass) or isinstance(
        e1, DataPropertyClass
    ):
    ...
    elif isinstance(e2, ObjectPropertyClass) or isinstance(
        e2, DataPropertyClass
    ):
